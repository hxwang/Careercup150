...
- 7.6 Given a two-dimensional graph with points on it, find a line which passes the most number of points. [[Solution]](https://github.com/hxwang/Leetcode/blob/master/code/Max-Points-on-a-Line.java)
